...
class ProgramEnrollment(Document):
	...
	def validate_duplication(self):
		...
		if enrollment:
			frappe.throw(
				_(
					"Student is already enrolled via Program Enrollment {0}. "
					"To enroll the student in additional courses, open that enrollment and add rows in Courses."
				).format(get_link_to_form("Program Enrollment", enrollment)),
