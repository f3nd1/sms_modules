...
def report_to_pdf(html, orientation="Landscape"):
	...
	html=html.replace('<ol>','<ol style="width:95%;margin: 0 auto;">')
	html=html.replace('<div class="ql-editor read-mode">','<div class="ql-editor read-mode" style="width:95%;margin: 0 auto;">')
